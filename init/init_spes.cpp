...
#define _REALLY_INCLUDE_SYS__SYSTEM_PROPERTIES_H_#include <sys/_system_properties.h>
...
void vendor_load_properties() {
  ...
  if (sys.totalram > 5072 ull * 1024 * 1024) {
    ...
    heapminfree = "8m";
    heapmaxfree = "32m";
  } else if (sys.totalram > 3072 ull * 1024 * 1024) {
